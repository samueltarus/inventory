            ...
            <div class="table-title">
				<div class="row">
                    ...
                    <a href="{{url('create-report')}}" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Create Report</span></a>
						<a href="{{ URL::to('/product-reports') }}" class="btn btn-danger" ><i class="material-icons">&#xE15C;</i> <span>Export to Excel</span></a>
					</div>
				</div>
			</div>
                        ...
                        <table class="table table-borderless table-striped table-earning">
                            ...
                            <tbody>
                                ...
                                <tr>
			            			...
			            			<a href="{{URL::to('/product-reports/'.$products->product_id)}}" class="btn btn-danger" ><i class="material-icons">&#xE15C;</i> <span>Export to Excel</span></a>
