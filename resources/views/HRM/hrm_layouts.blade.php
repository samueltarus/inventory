            ...
            <div class="section__content section__content--p10">
                <div class="header3-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img src="{{ asset('backened/images/icon/invento.png')}}" alt="CoolAdmin" style="width: auto;height:50px" />
                        </a>
                    </div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    ...
                                    <li>
                                        <a href="register.html">Upload NHIF Details</a>
                                    </li>
                                    <li>
                                        <a href="register.html">Upload NSSF Details</a>
                                    </li>
                                    <li>
                                        <a href="forget-pass.html">Upload KRA Details</a>
                                    </li>
                                    <li>
                                        <a href="register.html">Upload Bank Details</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="chart.html">
                                    <i class="fas fa-chart-bar"></i>Leave Management</a>
                            </li>
                            <li>
                                <a href="chart.html">
                                    <i class="fas fa-chart-bar"></i>Clearance Management</a>
                            </li>
                            <li>
                                <a href="chart.html">
                                    <i class="fas fa-chart-bar"></i>Requisition</a>
                            </li>
                    ...
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                ...
                                <div class="content">
                                    <a class="js-acc-btn" href="#">{{ Auth::user()->name }}</a></a>
                                </div>
